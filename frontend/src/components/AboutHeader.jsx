  ...
  return (
    <div className="bg-white py-10 px-4 sm:px-6 md:px-20">
      ...
      >
        ...
        <p className="text-[#4c3b2a] text-sm sm:text-base leading-relaxed font-quicksand">
        ...
        >
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1">
              ...
              <p className="text-[#4c3b2a] text-sm sm:text-base mb-4 font-quicksand">
              ...
              <p className="text-[#4c3b2a] text-sm sm:text-base font-quicksand">
            ...
            <div className="flex-1 flex flex-col gap-4">
              {[
                ...
                >
                  ...
                  <p className="text-sm font-quicksand">{item.desc}</p>
                </motion.div>
              ))}
            </div>
          </div>
      ...
      <section className="py-12">
        <div className="flex flex-col md:flex-row items-center gap-10 px-4">
          ...
          >
            ...
            <h3 className="text-lg sm:text-xl font-semibold mb-4 text-gray-600">
              [Founder's Name]
            </h3>
      ...
      {/* Why Choose ELA */}
      <section id="why-choose-ela" className="px-4 py-12">
        <div className="flex flex-col-reverse md:flex-row items-center gap-10">
          ...
          >
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 font-brick">
              WHY CHOOSE ELA
            </h2>
